...
namespace WeaponPaints
{
	internal static class Utility
	{
		...
		internal static void Log(string message)
		{
            ...
            WeaponPaints.Instance.Logger.LogInformation("[WeaponPaints] " + message);
			Console.ResetColor();
		}
		
		internal static IMenu? CreateMenu(string title)
		{
			var menuType = WeaponPaints.Instance.Config.MenuType;
            IMenu menu = MenuManager.MenuByType(menuType, title, WeaponPaints.Instance);
